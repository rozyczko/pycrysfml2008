...
module api_init
    ...
    function Init() result(m)
        ...
        call method_Table%add_method("hkls_from_spg","py_hkls_from_spg",METH_VARARGS,c_funloc(py_hkls_from_spg))
        call method_Table%add_method("ganu_from_xz","py_ganu_from_xz",METH_VARARGS,c_funloc(py_ganu_from_xz))
